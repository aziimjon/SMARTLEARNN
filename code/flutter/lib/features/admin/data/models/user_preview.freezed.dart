...
mixin _$UserPreview {
  ...
  /// Serializes this UserPreview to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of UserPreview
...
abstract class _$$UserPreviewImplCopyWith<$Res>
  ...
  factory _$$UserPreviewImplCopyWith(
    _$UserPreviewImpl value,
    $Res Function(_$UserPreviewImpl) then,
...
class __$$UserPreviewImplCopyWithImpl<$Res>
  ...
  __$$UserPreviewImplCopyWithImpl(
    _$UserPreviewImpl _value,
    $Res Function(_$UserPreviewImpl) _then,
  ) : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$UserPreviewImpl extends _UserPreview {
  ...
  @override
  String toString() {
    return 'UserPreview(id: $id, firstName: $firstName, lastName: $lastName, middleName: $middleName, email: $email, phoneNumber: $phoneNumber, status: $status, profileImageUrl: $profileImageUrl, profileBackgroundUrl: $profileBackgroundUrl, roles: $roles)';
  }
  ...
  Map<String, dynamic> toJson() {
    return _$$UserPreviewImplToJson(this);
  }
}

abstract class _UserPreview extends UserPreview {
