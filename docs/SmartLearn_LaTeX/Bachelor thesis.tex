...
\begin{titlepage}
\thispagestyle{empty}
\noindent\includegraphics[width=5.5cm]{figs/logo.png}
...
\noindent
\hfill Kurbanov Azimzhon\\[10pt]
Student:\\[6pt]
Supervisor: \hspace{3cm} Dr.sc.ing., Professor, Jelena Caiko
...
single existing platform. The Bachelor Paper is written in 41 pages and contains 12
tables, 10 figures, 3 listings, 2 annexes, and a list of references with 13 sources.

%--- Keywords ---
\vspace{1.5em}
\noindent{\large\bfseries Keywords}\par
\addcontentsline{toc}{chapter}{Keywords}
\vspace{0.4em}
\noindent\textbf{Keywords:} learning management system, Socratic AI coaching,
...
\caption{SmartLearn Admin Panel: course management screen (left) and user management screen (right)}
\label{fig:admin}
\end{figure}
...
maps directly to the group management structure in the PostgreSQL schema described in Section~2.5.
...
Hereby I, Azimzhon Kurbanov, affirm that the Bachelor's thesis was performed independently,
without the assistance of others; sources of data and definitions taken from external sources
are indicated in the thesis. This work has not been submitted to any other examination
commission and has not been published elsewhere.

\vspace{1cm}
Riga, 2026

\vspace{1.5cm}
\noindent\rule{6cm}{0.4pt} \hfill Azimzhon Kurbanov
